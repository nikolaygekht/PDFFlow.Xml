...
namespace Gehtsoft.PDFFlowLib.Xml
{
    public sealed partial class Creator
    {
        ...
        internal static NumerationStyle ToPDF(XmlPdfListNumerationStyle style) =>
            style switch
            {
                XmlPdfListNumerationStyle.arabic => NumerationStyle.Arabic,
                XmlPdfListNumerationStyle.lowerlatin => NumerationStyle.LowerLatin,
                XmlPdfListNumerationStyle.lowerroman => NumerationStyle.LowerRoman,
                XmlPdfListNumerationStyle.upperlatin => NumerationStyle.UpperLatin,
                XmlPdfListNumerationStyle.upperroman => NumerationStyle.UpperRoman,
                XmlPdfListNumerationStyle.lowercyrillic => NumerationStyle.LowerCyrillic,
                XmlPdfListNumerationStyle.uppercyrillic => NumerationStyle.UpperCyrillic,
